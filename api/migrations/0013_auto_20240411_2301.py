...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Seat',
            fields=[
                ('floorno', models.OneToOneField(db_column='FloorNo', on_delete=django.db.models.deletion.DO_NOTHING, unique=False, serialize=False, to='api.floor')),
